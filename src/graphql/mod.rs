...
pub fn build_schema(cfg: &Config, pool: Arc<PgPool>) -> Result<Schema> {
    ...
    for entity in &cfg.entities {
        ...
        let get_field = Field::new(get_name, TypeRef::named(&entity.name), move |ctx| {
